...
always target the same schema/config the app uses.
"""
...
# Inject the app's DB URL (Alembic's own value is left blank in alembic.ini).
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        # Batch mode makes ALTERs work on SQLite (recreate-table strategy).
        context.configure(
